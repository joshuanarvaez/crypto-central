          ...
          <Col className="stats-container">
                <Col className="coin-value-statistics">
                      <Col className="coin-value-statistics-heading">
                          ...
                          <p>An overview featuring statistics like base and quote currency, rank, and market cap.</p>
                      </Col>
                ...
                <Col className="other-stats-info">
                      <Col className="coin-value-statistics-heading">
                          <Title level={3} className="coin-details-heading">Other {data?.data?.coin.name} Statistics</Title>
                          <p>An overview featuring market, exchange, and supply statistics</p>
                      </Col>
